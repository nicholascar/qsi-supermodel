...
The formal definition of this profile is given below in human-readable form and in macehin-readable form in the file https://nicholascar.com/qsi-supermodel/qsi-placenames/profile.ttl[profile].
