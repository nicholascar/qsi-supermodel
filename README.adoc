...
* https://nicholascar.com/qsi-supermodel/backbone/backbone.ttl[Backbone Model]
** machine-readable version
* https://nicholascar.com/anz-nat-addr-model-candidate/model.html[Address Component Model]
** external to this Supermodel
* https://nicholascar.com/qsi-supermodel/supermodel.html#_qsi_place_names_model[Place Names Component Model]
** defined within this Supermodel
* https://nicholascar.com/qsi-supermodel/supermodel.html#_qsi_cadastral_model[Cadastre Component Model]
** defined within this Supermodel
